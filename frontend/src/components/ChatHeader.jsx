...
function ChatHeader() {
  ...
  return (
    <div
      className="flex items-center justify-between bg-slate-800/50 border-b border-slate-700/50 px-3 md:px-6 py-3 md:py-4 shrink-0"
    >
      ...
      <button onClick={() => setSelectedUser(null)} className="hidden md:flex items-center justify-center w-10 h-10 rounded-full hover:bg-slate-700/50 transition-colors">
