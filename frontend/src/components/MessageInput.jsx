    ...
    <div className="p-3 md:p-4 border-t border-slate-700/50 shrink-0">
      {imagePreview && (
        <div className="max-w-3xl mx-auto mb-3 flex items-center">
          <div className="relative">
            ...
            <button
              onClick={removeImage}
              className="absolute -top-2 -right-2 w-7 h-7 rounded-full bg-slate-800 flex items-center justify-center text-slate-200 hover:bg-slate-700"
      ...
      <form onSubmit={handleSendMessage} className="max-w-3xl mx-auto flex gap-2 md:gap-4">
        <input
          ...
          className="flex-1 bg-slate-800/50 border border-slate-700/50 rounded-lg py-3 md:py-2 px-4 text-slate-200"
        ...
        <button
          ...
          className={`bg-slate-800/50 text-slate-400 hover:text-slate-200 rounded-lg px-3 md:px-4 transition-colors flex items-center justify-center min-h-[44px] ${
        ...
        <button
          ...
          className="bg-gradient-to-r from-cyan-500 to-cyan-600 text-white rounded-lg px-3 md:px-4 py-3 md:py-2 font-medium hover:from-cyan-600 hover:to-cyan-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed min-h-[44px]"
