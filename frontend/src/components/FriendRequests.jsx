      ...
      <div className="space-y-2">
        {activeTab === "received" ? (
          friendRequests.map((req) => (
            <div key={req.sender._id} className="bg-slate-700/30 p-3 rounded-lg flex items-center justify-between gap-3">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="bg-green-600 hover:bg-green-700 text-white p-2 rounded-lg transition-colors min-h-[40px] min-w-[40px] flex items-center justify-center"
                >
                  <Check className="size-5" />
                </button>
                <button
                  onClick={() => rejectFriendRequest(req.sender._id)}
                  className="bg-red-600 hover:bg-red-700 text-white p-2 rounded-lg transition-colors min-h-[40px] min-w-[40px] flex items-center justify-center"
                >
                  <X className="size-5" />
                </button>
              </div>
          ...
          sentFriendRequests.map((req) => (
            <div key={req.receiver._id} className="bg-slate-700/30 p-3 rounded-lg flex items-center justify-between gap-3">
              <div className="flex items-center gap-2 min-w-0">
                <div className="avatar">
                  <div className="size-8 rounded-full">
