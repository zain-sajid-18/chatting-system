    ...
    <div className="p-3 md:p-4 border-b border-slate-700/50 shrink-0">
      ...
      <div className="flex gap-2 mb-3">
        <button
          ...
          className={`text-xs px-3 py-2 rounded-full transition-colors min-h-[40px] ${
            activeTab === "received"
      ...
      <div className="space-y-2">
        {activeTab === "received"
          ? friendRequests.map((req) => (
              <div
                key={req.sender._id}
                className="bg-slate-700/30 p-3 rounded-lg flex items-center justify-between gap-2"
              >
